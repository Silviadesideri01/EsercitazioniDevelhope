...
export function Welcome({ name = "Utente", age }) {
  ...
  return (
    <div>
      ...
      {age >= 18 ? <Age age={age} /> : <Messaggio/>}{/*L'età è maggiore o uguale a 18? se si, renderizza l'età: altrimenti mostra il messaggio*/}
      {age && <Age age={age}/>}{/*L'età deve essere inserita per essere renderizzata*/}
      {age > 18 && age < 65? <Age age={age}/> : ""} {/*L'età è maggiore di 18 E minore di 65? Se si, renderizzala*/}
      {age > 18 && name === "John"? <Age age={age}/> : ""}{/*l'età è maggiore di 18 E il nome è uguale a Jhon? Se si, renderizzalo*/}
    </div>
  );
}
